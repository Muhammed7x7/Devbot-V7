...
class Config:
    def __init__(self):
        ...
        # ✅ YENİ GEMINI AYARLARI (STABİL)
        self.GEMINI_MODEL = "gemini-1.5-flash-latest"
        self.GEMINI_API_URL = f"https://generativelanguage.googleapis.com/v1/models/{self.GEMINI_MODEL}:generateContent"
...
# ======================================================================
# 🤖 6. GEMINI İSTEMCİSİ (YENİ v1 API - 2026 UYUMLU)
# ======================================================================
    ...
    def __init__(self, api_key: str):
        ...
        try:
            ...
            if response.status_code == 200:
                self.available = True
                logger.info("✅ Gemini API bağlantısı kuruldu (v1 - 1.5-flash)")
            else:
                logger.error(f"❌ Gemini test hatası: {response.status_code}")
    ...
    async def chat(self, message: str) -> str:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return f"API Hatası ({response.status_code}): {response.text[:300]}"
...
if __name__ == "__main__":
    try:
        ...
        time.sleep(5)
        os.execv(sys.executable, ['python'] + sys.argv)        await main()
